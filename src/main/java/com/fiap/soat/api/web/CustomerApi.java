...
import com.fiap.soat.controllers.CustomerController;
...
import com.fiap.soat.presenters.CustomerPresenter;
...
public class CustomerApi {
  ...
  public Mono<CustomerResponse> create(@RequestBody @Valid final CustomerCreateRequest request) {
    return Mono.just(request)
        ...
        .flatMap(customerController::create)
  ...
  public Mono<CustomerResponse> getByDocumentNumber(@PathVariable final String documentNumber) {
    return Mono.just(documentNumber)
        ...
        .flatMap(customerController::getByDocumentNumber)
        .map(customerPresenter::toResponse);
  }
}
