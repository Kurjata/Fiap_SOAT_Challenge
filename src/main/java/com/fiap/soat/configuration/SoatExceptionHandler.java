package com.fiap.soat.configuration;

import com.fiap.soat.exception.ChallengeException;
import com.fiap.soat.model.response.exception.ErrorFieldResponse;
...
import static com.fiap.soat.model.enums.ServiceError.GENERIC_ERROR;
...
public class SoatExceptionHandler {
  ...
  public Mono<ResponseEntity<ExceptionResponse>> handlerException(final Exception ex) {
    return Mono.just(getMessage(GENERIC_ERROR.name()))
  ...
  public Mono<ResponseEntity<ExceptionResponse>> handlerException(
